...
print(voices[0].id)
engine.setProperty('voice', voices[0].id)  # Voice of Jarvis
...
def logic():
    ...
    # Playing a random music
        ...
        print("Playing Music...")
        # Jarvis surprise you a random music
    ...
    # Identity
        ...
        print("I am Jarvis. An AI Featured Destop Assistant")
        speak("I am Jarvis. An AI Featured Destop Assistant")
